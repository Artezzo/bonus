<?php
	...
	function logooos_init() 
	{
		...
		$labels = array(
			'name' => _x('Seguradoras', 'Post type general name'),
			'singular_name' => _x('Seguradoras', 'Post type singular name'),
			'add_new' => _x('Adicionar nova seguradora', 'logo Item'),
			'add_new_item' => __('Adicionar nova seguradora'),
			'edit_item' => __('Editar seguradora'),
			'new_item' => __('Nova seguradora'),
			'all_items' => __('Todas as seguradoras'),
			'view_item' => __('Ver'),
			'search_items' => __('Procurar'),
			'not_found' =>  __('Nenhuma seguradora encontrada'),
			'not_found_in_trash' => __('Nenhuma seguradora encontrada'), 
			'parent_item_colon' => '',
			'menu_name' => 'Seguradoras'
		);
		...
		$args = array(
			...
			'show_in_menu' => true, 
			'query_var' => true,
			'rewrite' => array( 'slug' => 'seguradoras' ),
		...
		register_taxonomy(
			...
			array(
				'hierarchical' => true,
				'labels' => array( 'name'=>'Categorias', 'add_new_item' => 'Adicionar nova Categoria', 'parent_item' => 'Parent Category'),
				'query_var' => true,
				'rewrite' => array( 'slug' => 'categoria-seguradoras' )
			)
		);
