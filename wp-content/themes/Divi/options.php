...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __( 'Configurações gerais', 'theme-textdomain' ),
		'type' => 'heading'
	);
	...
	$options[] = array(
		'name' => __( 'Configurações avançadas', 'theme-textdomain' ),
		'type' => 'heading'
	);

    $options[] = array(
		'name' => __( 'ID do formulário de captação de dados', 'theme-textdomain' ),
		'desc' => __( 'Insira o id do formulário responsável por capturar os dados de contato.', 'theme-textdomain' ),
		'id' => 'id_form_capture_data',
		'placeholder' => 'Insira aqui o ID',
		'type' => 'text'
	);

	$options[] = array(
		'name' => __( 'Selecione o formulário para captação de dados', 'theme-textdomain' ),
		'desc' => __( 'Selecione o formulário que será responsável por capturar os dados dos formulários de cotação', 'theme-textdomain' ),
		'id' => 'form_capture_data',
		'type' => 'select',
